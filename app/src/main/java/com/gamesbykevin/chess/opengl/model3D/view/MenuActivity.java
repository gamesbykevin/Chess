package com.gamesbykevin.chess.opengl.model3D.view;

import java.util.Locale;

import com.gamesbykevin.chess.R;
import com.gamesbykevin.chess.opengl.util.Utils;
import com.gamesbykevin.chess.opengl.util.content.ContentUtils;
import com.gamesbykevin.chess.opengl.util.view.TextActivity;
...
public class MenuActivity extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//setListAdapter(new ArrayAdapter<String>(this, R.layout.activity_menu_item, getResources().getStringArray(R.array.menu_items)));
	}
