package com.gamesbykevin.chess.opengl.model3D.services.wavefront;

import android.app.Activity;
import android.opengl.GLES20;
import android.util.Log;

import com.gamesbykevin.chess.opengl.model3D.controller.LoaderTask;
import com.gamesbykevin.chess.opengl.model3D.model.Object3DBuilder;
								 ...
								 final String assetsDir, final String modelId, final Object3DBuilder.Callback callback)
	{
		new LoaderTask(parent,url,currentDir,assetsDir,modelId,callback){
			...
			protected Object3DData build() throws IOException {
				...
				com.gamesbykevin.chess.opengl.model3D.services.WavefrontLoader wfl = new com.gamesbykevin.chess.opengl.model3D.services.WavefrontLoader("");
