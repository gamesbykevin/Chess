 ...
 */
public class BaseTurnGameActivity extends BaseGameActivity {

    /*
    public static final String TAG = "BaseTurnGameActivity";
    ...
    private void onConnected(GoogleSignInAccount googleSignInAccount) {
        ...
        if (DEBUG)
            UtilityHelper.logEvent("onConnected(): connected to Google APIs");
        ...
        if (DEBUG)
            UtilityHelper.logEvent("onConnected(): Connection successful");
    ...
    private void onDisconnected() {
        ...
        if (DEBUG)
            UtilityHelper.logEvent("onDisconnected()");
    ...
    public void onStartMatchClicked(View view) {
        mTurnBasedMultiplayerClient.getSelectOpponentsIntent(1, 7, true).addOnSuccessListener(new OnSuccessListener<Intent>() {
            @Override
            public void onSuccess(Intent intent) {
    ...
    public void onQuickMatchClicked(View view) {
        ...
        // Start the match
        mTurnBasedMultiplayerClient.createMatch(turnBasedMatchConfig).addOnSuccessListener(new OnSuccessListener<TurnBasedMatch>() {
            @Override
    ...
    public void onCancelClicked(View view) {
        ...
        mTurnBasedMultiplayerClient.cancelMatch(mMatch.getMatchId()).addOnSuccessListener(new OnSuccessListener<String>() {
            @Override
    ...
    public void onLeaveClicked(View view) {
        ...
        mTurnBasedMultiplayerClient.leaveMatchDuringTurn(mMatch.getMatchId(), nextParticipantId).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
    ...
    public void onDoneClicked(View view) {
        ...
        mTurnBasedMultiplayerClient.takeTurn(mMatch.getMatchId(), mTurnData.persist(), nextParticipantId)
            .addOnSuccessListener(new OnSuccessListener<TurnBasedMatch>() {
                @Override
                public void onSuccess(TurnBasedMatch turnBasedMatch) {
                    onUpdateMatch(turnBasedMatch);
...
// Sign-in, Sign out behavior
    ...
    private InvitationCallback mInvitationCallback = new InvitationCallback() {
        ...
        public void onInvitationReceived(@NonNull Invitation invitation) {
            Toast.makeText(BaseTurnGameActivity.this, "An invitation has arrived from " + invitation.getInviter().getDisplayName(), Toast.LENGTH_SHORT).show();
        }

        @Override
        public void onInvitationRemoved(@NonNull String invitationId) {
            Toast.makeText(BaseTurnGameActivity.this, "An invitation was removed.", Toast.LENGTH_SHORT).show();
        }
    };
    ...
    private TurnBasedMatchUpdateCallback mMatchUpdateCallback = new TurnBasedMatchUpdateCallback() {
        ...
        public void onTurnBasedMatchReceived(@NonNull TurnBasedMatch turnBasedMatch) {
            Toast.makeText(BaseTurnGameActivity.this, "A match was updated.", Toast.LENGTH_LONG).show();
        }

        @Override
        public void onTurnBasedMatchRemoved(@NonNull String matchId) {
            Toast.makeText(BaseTurnGameActivity.this, "A match was removed.", Toast.LENGTH_SHORT).show();
        }
    };
